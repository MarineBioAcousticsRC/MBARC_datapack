...
myProject = "MBARC_GulfOfMexico";
collectionSTR = "MBARC_GOM_";
mySource = "Scripps Institution of Oceanography";
mySponsors = "Scripps Institution of Oceanography;NOAA SEFSC"
myFunders = "DWH Restoration;NOAA NMFS Office of Science and Technology;US Navy Task Force Ocean;NOAA Restore Science Program;NOAA NMFS SERO";%GOM
myScientists = "Melissa Soldevilla;John Hildebrand;Kaitlin Frasier;Adolfo Gracia;Arturo Serrano;" + ...
    "Carrie Wall;Lance Garrison;Joel Ortega-Ortiz;Matthieu Le Henaff";
DATA_COMMENT = "This dataset includes raw acoustic recordings from each annual LISTEN GoMex HARP deployment over" + ...
    "the 2020-2025 period, plus associated HARP deployments from the 2018-2020 period. In addition to the raw " + ...
    "acoustic recordings, there are several associated files for these data which include calibration files " + ...
    "(transfer functions) and Long-term Spectral Averages (LTSAs) for sound exploration and accessibility. Three " + ...
    "readme files provide details on the acoustic recording\u2018s xwav format, LTSA format, and transfer function " + ...
    "descriptions. All recordings are collected in UTC.";
seaArea = "Gulf of Mexico";
